const CACHE_VERSION = "tekstura-offline-shell-v17";
...
const APP_SHELL_URLS = [
  ...
  "./app.js?v=20260603-auth-startup-hotfix",
...
function offlineFallbackResponse() {
  return new Response("Приложение ещё не подготовлено для офлайн-запуска. Откройте сайт один раз при интернете и нажмите Обновить.", {
